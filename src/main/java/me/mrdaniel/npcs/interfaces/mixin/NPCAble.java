...
public interface NPCAble {
	...
	void setNPCHorseType(@Nonnull final HorseType value);
	void setNPCZombieType(@Nonnull final ZombieType value);
	void setNPCSkeletonType(@Nonnull final SkeletonType value);
