...
public class CommandCopy extends NPCCommand {
	...
	public void execute(final Player player, final Living npc, final CommandContext args) throws CommandException {
		...
		npc.get(Keys.ZOMBIE_TYPE).ifPresent(value -> copy.offer(Keys.ZOMBIE_TYPE, value));
		npc.get(Keys.SKELETON_TYPE).ifPresent(value -> copy.offer(Keys.SKELETON_TYPE, value));
